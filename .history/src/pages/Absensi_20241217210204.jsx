...
const Absensi = () => {
  ...
  const [qrCode, setQrCode] = useState(
    "https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=http://192.168.43.180:3000/absensi"
  );

  // Fungsi generate QR Code baru
  const generateNewQRCode = () => {
    const newQrCode = `https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=http://192.168.43.180:3000/absensi/${Date.now()}`;
    setQrCode(newQrCode);
  };
