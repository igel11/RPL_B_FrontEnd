        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <header className="bg-white shadow-md p-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              >
                <i className="fas fa-bell text-xl text-gray-600 hover:text-blue-600"></i>
          ...
          <main className="flex-1 overflow-y-auto p-6 bg-gray-50">
            ...
            <div className="grid grid-cols-4 gap-6 mb-6">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-gray-500 mb-2">Absensi</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h2 className="text-xl font-semibold mb-4">Riwayat Aktifitas</h2>
              <div className="space-y-4">
                {activities.length > 0 ? (
                  ...
                  <p>Tidak Ada Riwayat Aktifitas</p>
                )}
              </div>
            </div>
          </main>
