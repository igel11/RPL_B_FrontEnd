...
const Laporan = () => {
  const [name, setName] = useState("users.name"); // Nama pengirim laporan
  const [subRole, setSubRole] = useState("users.subRole"); // Sub-Role atau peran pengguna
  ...
  const [tanggal_waktu, setTanggal] = useState(""); // URL gambar sementara untuk pratinjau
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("tanggal dan waktu", tanggal_waktu); // Menggunakan gambar yang disimpan di state
