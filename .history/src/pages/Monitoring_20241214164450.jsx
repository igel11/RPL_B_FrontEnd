import React, { useState, useEffect } from "react"; // Impor useEffect dan useState
import { Link } from "react-router-dom";
import io from "socket.io-client";

const Monitoring = () => {
  const [selectedLab, setSelectedLab] = useState("Cyber");
  const [labItems, setLabItems] = useState([]); // Menambahkan state untuk labItems
  ...
  useEffect(() => {
    ...
    socket.on("updateLabItems", (data) => {
      ...
      setLabItems(data); // Perbarui state dengan data terbaru dari server
    });
