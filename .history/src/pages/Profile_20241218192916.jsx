...
const Profile = () => {
  ...
  const navigate = useNavigate(); // Menambahkan hook navigate
  ...
  const handleBackClick = () => {
    navigate("/Dashboard"); // Mengarahkan ke halaman Dashboard saat tombol Kembali ditekan
  };
    ...
    <div className="bg-gray-100 flex flex-col items-center min-h-screen">
      <div className="w-full max-w-4xl mx-auto">
        <header className="w-full flex items-center justify-between p-6 bg-white shadow-md rounded-b-xl">
          {/* Tombol Kembali */}
          <button
            onClick={handleBackClick} // Menggunakan handleBackClick saat tombol Kembali ditekan
