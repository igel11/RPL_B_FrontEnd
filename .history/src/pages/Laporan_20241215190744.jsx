...
const Laporan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("name", "Nama Alat");
    formData.append("subRole", "Dosen");
    formData.append("alat", "Proyektor");
    formData.append("lokasi_ruangan", "Ruang A");
    formData.append("deskripsi_kerusakan", "Kerusakan pada proyektor");
    formData.append("gambar", fileInput.files[0]); // File yang dipilih dari input file
...
export default Laporan; // Move this to the bottom of the file
