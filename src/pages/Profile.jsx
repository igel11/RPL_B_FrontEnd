      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <main className="mt-8 space-y-6 flex flex-col items-center">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-lg">
            <h2 className="text-2xl font-semibold mb-4 text-gray-800 text-center">Sarazel</h2>
            <hr className="border-gray-200 mb-4" />
            
            {/* Form Edit Profil */}
            <div className="space-y-4">
              <div>
                <label className="text-lg font-medium text-gray-800">Nama</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="text-lg font-medium text-gray-800">Peran</label>
                <input 
                  type="text" 
                  value="Mahasiswa" 
                  readOnly 
            ...
            <div className="mt-6">
              <p className="text-lg font-medium text-gray-800">Riwayat aktivitas:</p>
